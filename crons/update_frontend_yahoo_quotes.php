	...
	if(isset($response->query) && isset($response->query->results)) {
		...
		if(isset($response->query->results->quote)) {
			...
			$rawdata = $response->query->results->quote;
                        ...
                        $params[] = (!isset($rawdata->Ask)?"NULL":str_replace(',', '', $rawdata->Ask));
                        //$query .= (!isset($rawdata->AverageDailyVolume)?"NULL":str_replace(',', '', $rawdata->AverageDailyVolume)).",";
                        $params[] = (!isset($rawdata->AverageDailyVolume)?"NULL":str_replace(',', '', $rawdata->AverageDailyVolume));
                        //$query .= (!isset($rawdata->Bid)?"NULL":str_replace(',', '', $rawdata->Bid)).",";
                        $params[] = (!isset($rawdata->Bid)?"NULL":str_replace(',', '', $rawdata->Bid));
                        //$query .= (!isset($rawdata->AskRealtime)?"NULL":str_replace(',', '', $rawdata->AskRealtime)).",";
                        $params[] = (!isset($rawdata->AskRealtime)?"NULL":str_replace(',', '', $rawdata->AskRealtime));
                        //$query .= (!isset($rawdata->BidRealtime)?"NULL":str_replace(',', '', $rawdata->BidRealtime)).",";
                        $params[] = (!isset($rawdata->BidRealtime)?"NULL":str_replace(',', '', $rawdata->BidRealtime));
                        //$query .= (!isset($rawdata->BookValue)?"NULL":str_replace(',', '', $rawdata->BookValue)).",";
                        $params[] = (!isset($rawdata->BookValue)?"NULL":str_replace(',', '', $rawdata->BookValue));
                        //$query .= (!isset($rawdata->Change)?"NULL":str_replace(',', '', $rawdata->Change)).",";
                        $params[] = (!isset($rawdata->Change)?"NULL":str_replace(',', '', $rawdata->Change));
                        //$query .= (!isset($rawdata->Commision)?"NULL":str_replace(',', '', $rawdata->Commision)).",";
                        $params[] = (!isset($rawdata->Commision)?"NULL":str_replace(',', '', $rawdata->Commision));
                        //$query .= "'".$rawdata->Currency."',";
                        $params[] = $rawdata->Currency;
                        //$query .= (!isset($rawdata->ChangeRealtime)?"NULL":str_replace(',', '', $rawdata->ChangeRealtime)).",";
                        $params[] = (!isset($rawdata->ChangeRealtime)?"NULL":str_replace(',', '', $rawdata->ChangeRealtime));
                        //$query .= (!isset($rawdata->AfterHoursChangeRealtime)?"NULL":str_replace(',', '', $rawdata->AfterHoursChangeRealtime)).",";
                        $params[] = (!isset($rawdata->AfterHoursChangeRealtime)?"NULL":str_replace(',', '', $rawdata->AfterHoursChangeRealtime));
                        //$query .= (!isset($rawdata->DividendShare)?"NULL":str_replace(',', '', $rawdata->DividendShare)).",";
                        $params[] = (!isset($rawdata->DividendShare)?"NULL":str_replace(',', '', $rawdata->DividendShare));
                        ...
                        $params[] = (!isset($rawdata->EarningsShare)?"NULL":str_replace(',', '', $rawdata->EarningsShare));
                        //$query .= (!isset($rawdata->EPSEstimateCurrentYear)?"NULL":str_replace(',', '', $rawdata->EPSEstimateCurrentYear)).",";
                        $params[] = (!isset($rawdata->EPSEstimateCurrentYear)?"NULL":str_replace(',', '', $rawdata->EPSEstimateCurrentYear));
                        //$query .= (!isset($rawdata->EPSEstimateNextYear)?"NULL":str_replace(',', '', $rawdata->EPSEstimateNextYear)).",";
                        $params[] = !isset($rawdata->EPSEstimateNextYear)?"NULL":str_replace(',', '', $rawdata->EPSEstimateNextYear));
                        //$query .= (!isset($rawdata->EPSEstimateNextQuarter)?"NULL":str_replace(',', '', $rawdata->EPSEstimateNextQuarter)).",";
                        $params[] = (!isset($rawdata->EPSEstimateNextQuarter)?"NULL":str_replace(',', '', $rawdata->EPSEstimateNextQuarter));
                        //$query .= (!isset($rawdata->DaysLow)?"NULL":str_replace(',', '', $rawdata->DaysLow)).",";
                        $params[] = (!isset($rawdata->DaysLow)?"NULL":str_replace(',', '', $rawdata->DaysLow));
                        //$query .= (!isset($rawdata->DaysHigh)?"NULL":str_replace(',', '', $rawdata->DaysHigh)).",";
                        $params[] = (!isset($rawdata->DaysHigh)?"NULL":str_replace(',', '', $rawdata->DaysHigh));
                        //$query .= (!isset($rawdata->YearLow)?"NULL":str_replace(',', '', $rawdata->YearLow)).",";
                        $params[] = (!isset($rawdata->YearLow)?"NULL":str_replace(',', '', $rawdata->YearLow));
                        //$query .= (!isset($rawdata->YearHigh)?"NULL":str_replace(',', '', $rawdata->YearHigh)).",";
                        $params[] = (!isset($rawdata->YearHigh)?"NULL":str_replace(',', '', $rawdata->YearHigh));
                        //$query .= (!isset($rawdata->HoldingsGainPercent)?"NULL":str_replace(',', '', $rawdata->HoldingsGainPercent)).",";
                        $params[] = (!isset($rawdata->HoldingsGainPercent)?"NULL":str_replace(',', '', $rawdata->HoldingsGainPercent));
                        //$query .= (!isset($rawdata->AnnualizedGain)?"NULL":str_replace(',', '', $rawdata->AnnualizedGain)).",";
                        $params[] = (!isset($rawdata->AnnualizedGain)?"NULL":str_replace(',', '', $rawdata->AnnualizedGain));
                        //$query .= (!isset($rawdata->HoldingsGain)?"NULL":str_replace(',', '', $rawdata->HoldingsGain)).",";
                        $params[] = (!isset($rawdata->HoldingsGain)?"NULL":str_replace(',', '', $rawdata->HoldingsGain));
                        //$query .= (!isset($rawdata->HoldingsGainPercentRealtime)?"NULL":str_replace(',', '', $rawdata->HoldingsGainPercentRealtime)).",";
                        $params[] = (!isset($rawdata->HoldingsGainPercentRealtime)?"NULL":str_replace(',', '', $rawdata->HoldingsGainPercentRealtime));
                        //$query .= (!isset($rawdata->HoldingsGainRealtime)?"NULL":str_replace(',', '', $rawdata->HoldingsGainRealtime)).",";
                        $params[] = (!isset($rawdata->HoldingsGainRealtime)?"NULL":str_replace(',', '', $rawdata->HoldingsGainRealtime));
                        ...
                        $params[] = (!isset($rawdata->OrderBookRealtime)?"NULL":str_replace(',', '', $rawdata->OrderBookRealtime));
                        //$query .= (!isset($rawdata->MarketCapitalization)?"NULL":str_replace(',', '', $rawdata->MarketCapitalization)).",";
                        $params[] = (!isset($rawdata->MarketCapitalization)?"NULL":str_replace(',', '', $rawdata->MarketCapitalization));
                        //$query .= (!isset($rawdata->MarketCapRealtime)?"NULL":str_replace(',', '', $rawdata->MarketCapRealtime)).",";
                        $params[] = !isset($rawdata->MarketCapRealtime)?"NULL":str_replace(',', '', $rawdata->MarketCapRealtime));
                        //$query .= (!isset($rawdata->EBITDA)?"NULL":str_replace(',', '', $rawdata->EBITDA)).",";
                        $params[] = (!isset($rawdata->EBITDA)?"NULL":str_replace(',', '', $rawdata->EBITDA));
                        //$query .= (!isset($rawdata->ChangeFromYearLow)?"NULL":str_replace(',', '', $rawdata->ChangeFromYearLow)).",";
                        $params[] = (!isset($rawdata->ChangeFromYearLow)?"NULL":str_replace(',', '', $rawdata->ChangeFromYearLow));
                        //$query .= (!isset($rawdata->PercentChangeFromYearLow)?"NULL":str_replace(',', '', $rawdata->PercentChangeFromYearLow)).",";
                        $params[] = (!isset($rawdata->PercentChangeFromYearLow)?"NULL":str_replace(',', '', $rawdata->PercentChangeFromYearLow));
                        ...
                        $params[] = (!isset($rawdata->ChangePercentRealtime)?"NULL":str_replace(',', '', $rawdata->ChangePercentRealtime));
                        //$query .= (!isset($rawdata->ChangeFromYearHigh)?"NULL":str_replace(',', '', $rawdata->ChangeFromYearHigh)).",";
                        $params[] = (!isset($rawdata->ChangeFromYearHigh)?"NULL":str_replace(',', '', $rawdata->ChangeFromYearHigh))
                        //$query .= (!isset($rawdata->PercebtChangeFromYearHigh)?"NULL":str_replace(',', '', $rawdata->PercebtChangeFromYearHigh));
                        $params[] = (!isset($rawdata->PercebtChangeFromYearHigh)?"NULL":str_replace(',', '', $rawdata->PercebtChangeFromYearHigh));
                        //$query .= ")";
                        //mysql_query($query) or die(mysql_error());
                        try {
                        ...
                        $params[] = (!isset($rawdata->LastTradePriceOnly)?"NULL":str_replace(',', '', $rawdata->LastTradePriceOnly));
                        //$query .= (!isset($rawdata->HighLimit)?"NULL":str_replace(',', '', $rawdata->HighLimit)).",";
                        $params[] = (!isset($rawdata->HighLimit)?"NULL":str_replace(',', '', $rawdata->HighLimit));
                        //$query .= (!isset($rawdata->LowLimit)?"NULL":str_replace(',', '', $rawdata->LowLimit)).",";
                        $params[] = (!isset($rawdata->LowLimit)?"NULL":str_replace(',', '', $rawdata->LowLimit));
                        //$query .= (!isset($rawdata->FiftydayMovingAverage)?"NULL":str_replace(',', '', $rawdata->FiftydayMovingAverage)).",";
                        $params[] = (!isset($rawdata->FiftydayMovingAverage)?"NULL":str_replace(',', '', $rawdata->FiftydayMovingAverage))
                        //$query .= (!isset($rawdata->TwoHundreddayMovingAverage)?"NULL":str_replace(',', '', $rawdata->TwoHundreddayMovingAverage)).",";
                        $params[] = (!isset($rawdata->TwoHundreddayMovingAverage)?"NULL":str_replace(',', '', $rawdata->TwoHundreddayMovingAverage));
                        //$query .= (!isset($rawdata->ChangeFromTwoHundreddayMovingAverage)?"NULL":str_replace(',', '', $rawdata->ChangeFromTwoHundreddayMovingAverage)).",";
                        $params[] = (!isset($rawdata->ChangeFromTwoHundreddayMovingAverage)?"NULL":str_replace(',', '', $rawdata->ChangeFromTwoHundreddayMovingAverage));
                        ...
                        $params[] = (!isset($rawdata->PercentChangeFromTwoHundreddayMovingAverage)?"NULL":str_replace(',', '', $rawdata->PercentChangeFromTwoHundreddayMovingAverage));
                        //$query .= (!isset($rawdata->ChangeFromFiftydayMovingAverage)?"NULL":str_replace(',', '', $rawdata->ChangeFromFiftydayMovingAverage)).",";
                        $params[] = (!isset($rawdata->ChangeFromFiftydayMovingAverage)?"NULL":str_replace(',', '', $rawdata->ChangeFromFiftydayMovingAverage));
                        ...
                        $params[] = (!isset($rawdata->PercentChangeFromFiftydayMovingAverage)?"NULL":str_replace(',', '', $rawdata->PercentChangeFromFiftydayMovingAverage));
                        ...
                        $params[] = (!isset($rawdata->Open)?"NULL":str_replace(',', '', $rawdata->Open));
                        //$query .= (!isset($rawdata->PreviousClose)?"NULL":str_replace(',', '', $rawdata->PreviousClose)).",";
                        $params[] = (!isset($rawdata->PreviousClose)?"NULL":str_replace(',', '', $rawdata->PreviousClose));
                        //$query .= (!isset($rawdata->PricePaid)?"NULL":str_replace(',', '', $rawdata->PricePaid)).",";
                        $params[] = (!isset($rawdata->PricePaid)?"NULL":str_replace(',', '', $rawdata->PricePaid));
                        //$query .= (!isset($rawdata->ChangeinPercent)?"NULL":str_replace(',', '', $rawdata->ChangeinPercent)).",";
                        $params[] = (!isset($rawdata->ChangeinPercent)?"NULL":str_replace(',', '', $rawdata->ChangeinPercent));
                        //$query .= (!isset($rawdata->PriceSales)?"NULL":str_replace(',', '', $rawdata->PriceSales)).",";
                        $params[] = (!isset($rawdata->PriceSales)?"NULL":str_replace(',', '', $rawdata->PriceSales));
                        //$query .= (!isset($rawdata->PriceBook)?"NULL":str_replace(',', '', $rawdata->PriceBook)).",";
                        $params[] = (!isset($rawdata->PriceBook)?"NULL":str_replace(',', '', $rawdata->PriceBook));
                        ...
                        $params[] = (!isset($rawdata->PERatio)?"NULL":str_replace(',', '', $rawdata->PERatio));
                        ...
                        $params[] = (!isset($rawdata->PERatioRealtime)?"NULL":str_replace(',', '', $rawdata->PERatioRealtime));
                        //$query .= (!isset($rawdata->PEGRatio)?"NULL":str_replace(',', '', $rawdata->PEGRatio)).",";
                        $params[] = (!isset($rawdata->PEGRatio)?"NULL":str_replace(',', '', $rawdata->PEGRatio));
                        //$query .= (!isset($rawdata->PriceEPSEstimateCurrentYear)?"NULL":str_replace(',', '', $rawdata->PriceEPSEstimateCurrentYear)).",";
                        $params[] = (!isset($rawdata->PriceEPSEstimateCurrentYear)?"NULL":str_replace(',', '', $rawdata->PriceEPSEstimateCurrentYear));
                        //$query .= (!isset($rawdata->PriceEPSEstimateNextYear)?"NULL":str_replace(',', '', $rawdata->PriceEPSEstimateNextYear)).",";
                        $params[] = (!isset($rawdata->PriceEPSEstimateNextYear)?"NULL":str_replace(',', '', $rawdata->PriceEPSEstimateNextYear));
                        //$query .= (!isset($rawdata->SharesOwned)?"NULL":str_replace(',', '', $rawdata->SharesOwned)).",";
                        $params[] = (!isset($rawdata->SharesOwned)?"NULL":str_replace(',', '', $rawdata->SharesOwned));
                        //$query .= (!isset($rawdata->ShortRatio)?"NULL":str_replace(',', '', $rawdata->ShortRatio)).",";
                        $params[] = (!isset($rawdata->ShortRatio)?"NULL":str_replace(',', '', $rawdata->ShortRatio));
                        ...
                        $params[] = (!isset($rawdata->OneyrTargetPrice)?"NULL":str_replace(',', '', $rawdata->OneyrTargetPrice));
                        //$query .= (!isset($rawdata->Volume)?"NULL":str_replace(',', '', $rawdata->Volume)).",";
                        $params[] = (!isset($rawdata->Volume)?"NULL":str_replace(',', '', $rawdata->Volume));
                        //$query .= (!isset($rawdata->HoldingsValue)?"NULL":str_replace(',', '', $rawdata->HoldingsValue)).",";
                        $params[] = (!isset($rawdata->HoldingsValue)?"NULL":str_replace(',', '', $rawdata->HoldingsValue));
                        //$query .= (!isset($rawdata->HoldingsValueRealtime)?"NULL":str_replace(',', '', $rawdata->HoldingsValueRealtime)).",";
                        $params[] = (!isset($rawdata->HoldingsValueRealtime)?"NULL":str_replace(',', '', $rawdata->HoldingsValueRealtime));
                        //$query .= (!isset($rawdata->DaysValueChange)?"NULL":str_replace(',', '', $rawdata->DaysValueChange)).",";
                        $params[] = (!isset($rawdata->DaysValueChange)?"NULL":str_replace(',', '', $rawdata->DaysValueChange));
                        //$query .= (!isset($rawdata->DaysValueChangeRealtime)?"NULL":str_replace(',', '', $rawdata->DaysValueChangeRealtime)).",";
                        $params[] = (!isset($rawdata->DaysValueChangeRealtime)?"NULL":str_replace(',', '', $rawdata->DaysValueChangeRealtime));
                        ...
                        $params[] = (!isset($rawdata->DividendYield)?"NULL":str_replace(',', '', $rawdata->DividendYield));
                        //$query .= (!isset($rawdata->PercentChange)?"NULL":str_replace(',', '', $rawdata->Per
                        $params[] = (!isset($rawdata->PercentChange)?"NULL":str_replace(',', '', $rawdata->PercentChange));
                        //$query .= (!isset($rawdata->SharesOutstanding)?"NULL":str_replace(',', '', $rawdata->SharesOutstanding));
                        $params[] = (!isset($rawdata->SharesOutstanding)?"NULL":str_replace(',', '', $rawdata->SharesOutstanding));
                        //$query .= ")";                        
                        //mysql_query($query) or die(mysql_error());
                        try {
                                $res = $db->prepare($query);
                                $res->execute(array($params));
                        } catch(PDOException $ex) {
                                echo "\nDatabase Error"; //user message
                                die("Line: ".__LINE__." - ".$ex->getMessage());
                        }

...
while ($row = $res->fetch(PDO::FETCH_ASSOC)) {
    ...
    if(isset($response->query) && isset($response->query->results)) {
        ...
        if(isset($response->query->results->result) && isset($response->query->results->result->earningsTrend) && isset($response->query->results->result->earningsTrend->trend)) {

...
function update_raw_data_yahoo_estimates($ticker_id, $rawdata) {
    ...
    //First update yahoo quotes replacement fields
    $query = "INSERT INTO `tickers_yahoo_quotes_1` (`ticker_id`, `EPSEstimateNextQuarter`, `EPSEstimateNextYear`, `EPSEstimateCurrentYear`) VALUES (?, ?, ?, ?) ON DUPLICATE KEY UPDATE `EPSEstimateNextQuarter` = ?, `EPSEstimateNextYear` = ?, `EPSEstimateCurrentYear` = ?";
    $params = array();

...
function updateCAGR_KR($table, $years, $i, $report_id, $rawdata, $ticker_id) {
    ...
    $query .= updateCAGR_concat($vv, $va, $years);
    $va = (($rawdata["EBIT"][$i]=='null'||($rawdata["TotalShorttermDebt"][$i]=='null'&&$rawdata["NotesPayable"][$i]=='null'&&$rawdata["TotalLongtermDebt"][$i]=='null'&&$rawdata["TotalStockholdersEquity"][$i]=='null'&&$rawdata["CashCashEquivalentsandShorttermInvestments"][$i]=='null')||($rawdata["TotalShorttermDebt"][$i]+$rawdata["NotesPayable"][$i]+$rawdata["TotalLongtermDebt"][$i]+$rawdata["TotalStockholdersEquity"][$i]-$rawdata["CashCashEquivalentsandShorttermInvestments"][$i]==0))?null:(($rawdata["EBIT"][$i]*(1-$rawdata["TaxRatePercent"][$i])) / ($rawdata["TotalShorttermDebt"][$i]+$rawdata["NotesPayable"][$i]+$rawdata["TotalLongtermDebt"][$i]+$rawdata["TotalStockholdersEquity"][$i]-$rawdata["CashCashEquivalentsandShorttermInvestments"][$i])));
    $vv = (($rawdata["EBIT"][$i-$years]=='null'||($rawdata["TotalShorttermDebt"][$i-$years]=='null'&&$rawdata["NotesPayable"][$i-$years]=='null'&&$rawdata["TotalLongtermDebt"][$i-$years]=='null'&&$rawdata["TotalStockholdersEquity"][$i-$years]=='null'&&$rawdata["CashCashEquivalentsandShorttermInvestments"][$i-$years]=='null')||($rawdata["TotalShorttermDebt"][$i-$years]+$rawdata["NotesPayable"][$i-$years]+$rawdata["TotalLongtermDebt"][$i-$years]+$rawdata["TotalStockholdersEquity"][$i-$years]-$rawdata["CashCashEquivalentsandShorttermInvestments"][$i-$years]==0))?null:(($rawdata["EBIT"][$i-$years]*(1-$rawdata["TaxRatePercent"][$i-$years])) / ($rawdata["TotalShorttermDebt"][$i-$years]+$rawdata["NotesPayable"][$i-$years]+$rawdata["TotalLongtermDebt"][$i-$years]+$rawdata["TotalStockholdersEquity"][$i-$years]-$rawdata["CashCashEquivalentsandShorttermInvestments"][$i-$years])));
    $query .= updateCAGR_concat($vv, $va, $years);

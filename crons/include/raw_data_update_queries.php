...
function update_raw_data_tickers($dates, $rawdata) {
	...
	$query = "INSERT INTO `tickers_metadata_eol` (`ticker_id`, `TotalSharesOutstandingDate`, `BusinessDescription`, `CITY`, `Country`, `Formername`, `Industry`, `InvRelationsEmail`, `LastAnnualEPS`, `LastAnnualNetIncome`, `LastAnnualRevenue`, `LastAnnualTotalAssets`, `PhoneAreaCode`, `PhoneCountryCode`, `PhoneNumber`, `PublicFloat`, `PublicFloatDate`, `Sector`, `State`, `StateofIncorporation`, `StreetAddress1`, `StreetAddress2`, `TaxID`, `WebSiteURL`, `ZipCode`) VALUES (";
        ...
        $query .= ($rawdata["CITY"][26]=='null' ? 'null,':"'".mysql_real_escape_string($rawdata["CITY"][26])."',");
        $query .= ($rawdata["Country"][26]=='null' ? 'null,':"'".mysql_real_escape_string($rawdata["Country"][26])."',");
        $query .= ($rawdata["Formername"][26]=='null' ? 'null,':"'".mysql_real_escape_string($rawdata["Formername"][26])."',");
        $query .= ($rawdata["Industry"][26]=='null' ? 'null,':"'".mysql_real_escape_string($rawdata["Industry"][26])."',");
        $query .= ($rawdata["InvRelationsEmail"][26]=='null' ? 'null,':"'".mysql_real_escape_string($rawdata["InvRelationsEmail"][26])."',");
        ...
        $query .= ($rawdata["PhoneAreaCode"][26]=='null' ? 'null,':"'".mysql_real_escape_string($rawdata["PhoneAreaCode"][26])."',");
        $query .= ($rawdata["PhoneCountryCode"][26]=='null' ? 'null,':"'".mysql_real_escape_string($rawdata["PhoneCountryCode"][26])."',");
        $query .= ($rawdata["PhoneNumber"][26]=='null' ? 'null,':"'".mysql_real_escape_string($rawdata["PhoneNumber"][26])."',");
        $query .= $rawdata["PublicFloat"][26].",";
        $query .= "'".date("Y-m-d",strtotime($rawdata["PublicFloatDate"][26]))."',";
        $query .= ($rawdata["Sector"][26]=='null' ? 'null,':"'".mysql_real_escape_string($rawdata["Sector"][26])."',");
        $query .= ($rawdata["State"][26]=='null' ? 'null,':"'".mysql_real_escape_string($rawdata["State"][26])."',");
        $query .= ($rawdata["StateofIncorporation"][26]=='null' ? 'null,':"'".mysql_real_escape_string($rawdata["StateofIncorporation"][26])."',");
        $query .= ($rawdata["StreetAddress1"][26]=='null' ? 'null,':"'".mysql_real_escape_string($rawdata["StreetAddress1"][26])."',");
        $query .= ($rawdata["StreetAddress2"][26]=='null' ? 'null,':"'".mysql_real_escape_string($rawdata["StreetAddress2"][26])."',");
        $query .= ($rawdata["TaxID"][26]=='null' ? 'null,':"'".mysql_real_escape_string($rawdata["TaxID"][26])."',");
        $query .= ($rawdata["WebSiteURL"][26]=='null' ? 'null,':"'".mysql_real_escape_string($rawdata["WebSiteURL"][26])."',");
        $query .= ($rawdata["ZipCode"][26]=='null' ? 'null':"'".mysql_real_escape_string($rawdata["ZipCode"][26])."'");
        $query .= ")";
        mysql_query($query) or die ($query."\n".mysql_error());

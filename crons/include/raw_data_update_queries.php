    ...
    for($i=1; $i<=$treports; $i++) {
        if (!is_numeric($rawdata["duration"][$i])) {
            ...
            if ($affected_rows>0) {
                ...
                //GrossProfit fix
                if($rawdata["GrossProfit"][$i] == 'null') {
                    $rawdata["GrossProfit"][$i] = $rawdata["TotalRevenue"][$i];
                }
                ...
                if($i <= $areports) {
                    ...
                    $params[] = $max_min_array["ReportDatePrice"][$i] = $price;
                    $params[] = $max_min_array["CashFlow"][$i] = ((($rawdata["GrossProfit"][$i]=='null'&&$rawdata["OperatingExpenses"][$i]=='null' && is_null($CapEx)) || $rawdata["TaxRatePercent"][$i]=='null')?null:(($rawdata["GrossProfit"][$i]-$rawdata["OperatingExpenses"][$i]-$CapEx)*(1-$rawdata["TaxRatePercent"][$i])));
                    $params[] = $max_min_array["MarketCap"][$i] = (($rawdata["SharesOutstandingDiluted"][$i]=='null'||is_null($price))? null:(toFloat($rawdata["SharesOutstandingDiluted"][$i])*1000000*$price));
                    $params[] = $max_min_array["EnterpriseValue"][$i] = $entValue;
                    $params[] = $max_min_array["GoodwillIntangibleAssetsNet"][$i] = $rawdata["GoodwillIntangibleAssetsNet"][$i];
                    $params[] = $max_min_array["TangibleBookValue"][$i] = (($rawdata["TotalStockholdersEquity"][$i]=='null'&&$rawdata["GoodwillIntangibleAssetsNet"][$i]=='null')?null:($rawdata["TotalStockholdersEquity"][$i] - $rawdata["GoodwillIntangibleAssetsNet"][$i]));
                    $params[] = $max_min_array["ExcessCash"][$i] = (($rawdata["CashCashEquivalentsandShorttermInvestments"][$i]=='null' ||($rawdata["CashCashEquivalentsandShorttermInvestments"][$i]=='null'&&$rawdata["TotalCurrentLiabilities"][$i]=='null'&&$rawdata["TotalCurrentAssets"][$i]=='null'&&$rawdata["LongtermInvestments"][$i]=='null'))?null:(($rawdata["CashCashEquivalentsandShorttermInvestments"][$i] + $rawdata["LongtermInvestments"][$i]) - max(0, ($rawdata["TotalCurrentLiabilities"][$i]-$rawdata["TotalCurrentAssets"][$i]+$rawdata["CashCashEquivalentsandShorttermInvestments"][$i]))));
                    $params[] = $max_min_array["TotalInvestedCapital"][$i] = (($rawdata["TotalShorttermDebt"][$i]=='null'&&$rawdata["TotalLongtermDebt"][$i]=='null'&&$rawdata["TotalStockholdersEquity"][$i]=='null')?null:($rawdata["TotalShorttermDebt"][$i]+$rawdata["TotalLongtermDebt"][$i]+$rawdata["TotalStockholdersEquity"][$i]));
                    $params[] = $max_min_array["WorkingCapital"][$i] = (($rawdata["TotalCurrentAssets"][$i]=='null'&&$rawdata["TotalCurrentLiabilities"][$i]=='null')?null:($rawdata["TotalCurrentAssets"][$i] - $rawdata["TotalCurrentLiabilities"][$i]));
                    $params[] = $max_min_array["P_E"][$i] = ((is_null($price)||$rawdata["EPSDiluted"][$i]=='null'||$rawdata["EPSDiluted"][$i]==0)?null:($price / toFloat($rawdata["EPSDiluted"][$i])));
                    $params[] = $max_min_array["P_E_CashAdjusted"][$i] = (($rawdata["SharesOutstandingDiluted"][$i]=='null'||$rawdata["SharesOutstandingDiluted"][$i]=='null'||$rawdata["SharesOutstandingDiluted"][$i]==0||$rawdata["EPSDiluted"][$i]=='null'||$rawdata["EPSDiluted"][$i]==0)?null:((((toFloat($rawdata["SharesOutstandingDiluted"][$i])*1000000*$price)-$rawdata["CashCashEquivalentsandShorttermInvestments"][$i])/(toFloat($rawdata["SharesOutstandingDiluted"][$i])*1000000))/toFloat($rawdata["EPSDiluted"][$i])));
                    $params[] = $max_min_array["EV_EBITDA"][$i] = ((is_null($entValue)||$rawdata["EBITDA"][$i]=='null'||$rawdata["EBITDA"][$i]==0)?null:($entValue / $rawdata["EBITDA"][$i]));
                    $params[] = $max_min_array["EV_EBIT"][$i] = ((is_null($entValue)||$rawdata["EBIT"][$i]=='null'||$rawdata["EBIT"][$i]==0)?null:($entValue / $rawdata["EBIT"][$i]));
                    $params[] = $max_min_array["P_S"][$i] = ((is_null($price)||$rawdata["TotalRevenue"][$i]=='null'||$rawdata["TotalRevenue"][$i]==0||$rawdata["SharesOutstandingDiluted"][$i]=='null'||$rawdata["SharesOutstandingDiluted"][$i]==0)?null:($price / ($rawdata["TotalRevenue"][$i]/(toFloat($rawdata["SharesOutstandingDiluted"][$i])*1000000))));
                    $params[] = $max_min_array["P_BV"][$i] = ((is_null($price)||$rawdata["TotalStockholdersEquity"][$i]=='null'||$rawdata["TotalStockholdersEquity"][$i]==0||$rawdata["SharesOutstandingDiluted"][$i]=='null'||$rawdata["SharesOutstandingDiluted"][$i]==0)?'null':($price / ($rawdata["TotalStockholdersEquity"][$i]/(toFloat($rawdata["SharesOutstandingDiluted"][$i])*1000000))));
                    $params[] = $max_min_array["P_Tang_BV"][$i] = ((is_null($price)||($rawdata["TotalStockholdersEquity"][$i]=='null'&&$rawdata["GoodwillIntangibleAssetsNet"][$i]=='null')||$rawdata["SharesOutstandingDiluted"][$i]=='null'||$rawdata["SharesOutstandingDiluted"][$i]==0||($rawdata["TotalStockholdersEquity"][$i] - $rawdata["GoodwillIntangibleAssetsNet"][$i]==0))?null:($price / (($rawdata["TotalStockholdersEquity"][$i] - $rawdata["GoodwillIntangibleAssetsNet"][$i])/(toFloat($rawdata["SharesOutstandingDiluted"][$i])*1000000))));
                    $params[] = $max_min_array["P_CF"][$i] = ((is_null($price)||($rawdata["GrossProfit"][$i]=='null'&&$rawdata["OperatingExpenses"][$i]=='null'&&is_null($CapEx))||$rawdata["SharesOutstandingDiluted"][$i]=='null'||$rawdata["SharesOutstandingDiluted"][$i]==0||($rawdata["GrossProfit"][$i]-$rawdata["OperatingExpenses"][$i]-$CapEx==0)||$rawdata["TaxRatePercent"][$i]==1)?null:($price / ((($rawdata["GrossProfit"][$i]-$rawdata["OperatingExpenses"][$i]-$CapEx)*(1-$rawdata["TaxRatePercent"][$i]))/(toFloat($rawdata["SharesOutstandingDiluted"][$i])*1000000))));
                    $params[] = $max_min_array["P_FCF"][$i] = ((is_null($price)||is_null($FreeCashFlow)||$FreeCashFlow==0||$rawdata["SharesOutstandingDiluted"][$i]=='null'||$rawdata["SharesOutstandingDiluted"][$i]==0)?null:($price / ($FreeCashFlow/(toFloat($rawdata["SharesOutstandingDiluted"][$i])*1000000))));
                    $params[] = $max_min_array["P_OwnerEarnings"][$i] = ((is_null($price)||is_null($OwnerEarningsFCF)||$OwnerEarningsFCF==0||$rawdata["SharesOutstandingDiluted"][$i]=='null'||$rawdata["SharesOutstandingDiluted"][$i]==0)?null:($price / ($OwnerEarningsFCF/(toFloat($rawdata["SharesOutstandingDiluted"][$i])*1000000))));
                    $params[] = $max_min_array["FCF_S"][$i] = ((is_null($FreeCashFlow)||$rawdata["TotalRevenue"][$i]=='null'||$rawdata["TotalRevenue"][$i]==0)?null:($FreeCashFlow / $rawdata["TotalRevenue"][$i]));
                    $params[] = $max_min_array["FCFYield"][$i] = ((is_null($price)||$price==0||is_null($FreeCashFlow)||$FreeCashFlow==0||$rawdata["SharesOutstandingDiluted"][$i]=='null'||$rawdata["SharesOutstandingDiluted"][$i]==0)?null:(1 / ($price / ($FreeCashFlow/(toFloat($rawdata["SharesOutstandingDiluted"][$i])*1000000)))));
                    $params[] = $max_min_array["MagicFormulaEarningsYield"][$i] = (($rawdata["EBIT"][$i]=='null'||is_null($entValue)||$entValue==0)?null:($rawdata["EBIT"][$i] / $entValue));
                    $params[] = $max_min_array["ROE"][$i] = (($rawdata["NetIncome"][$i]=='null'||$rawdata["TotalStockholdersEquity"][$i]=='null'||$rawdata["TotalStockholdersEquity"][$i]==0)?null:($rawdata["NetIncome"][$i] / $rawdata["TotalStockholdersEquity"][$i]));
                    $params[] = $max_min_array["ROA"][$i] = (($rawdata["NetIncome"][$i]=='null'||$rawdata["TotalAssets"][$i]=='null'||$rawdata["TotalAssets"][$i]==0)?null:($rawdata["NetIncome"][$i] / $rawdata["TotalAssets"][$i]));
                    $params[] = $max_min_array["ROIC"][$i] = (($rawdata["EBIT"][$i]=='null'||($rawdata["TotalShorttermDebt"][$i]=='null'&&$rawdata["NotesPayable"][$i]=='null'&&$rawdata["TotalLongtermDebt"][$i]=='null'&&$rawdata["TotalStockholdersEquity"][$i]=='null'&&$rawdata["CashCashEquivalentsandShorttermInvestments"][$i]=='null')||($rawdata["TotalShorttermDebt"][$i]+$rawdata["NotesPayable"][$i]+$rawdata["TotalLongtermDebt"][$i]+$rawdata["TotalStockholdersEquity"][$i]-$rawdata["CashCashEquivalentsandShorttermInvestments"][$i]==0))?null:(($rawdata["EBIT"][$i]*(1-$rawdata["TaxRatePercent"][$i])) / ($rawdata["TotalShorttermDebt"][$i]+$rawdata["NotesPayable"][$i]+$rawdata["TotalLongtermDebt"][$i]+$rawdata["TotalStockholdersEquity"][$i]-$rawdata["CashCashEquivalentsandShorttermInvestments"][$i])));
                    $params[] = $max_min_array["CROIC"][$i] = ((is_null($FreeCashFlow)||($rawdata["TotalShorttermDebt"][$i]=='null'&&$rawdata["TotalLongtermDebt"][$i]=='null'&&$rawdata["TotalStockholdersEquity"][$i]=='null')||($rawdata["TotalShorttermDebt"][$i]+$rawdata["TotalLongtermDebt"][$i]+$rawdata["TotalStockholdersEquity"][$i]==0))?null:($FreeCashFlow / ($rawdata["TotalShorttermDebt"][$i]+$rawdata["TotalLongtermDebt"][$i]+$rawdata["TotalStockholdersEquity"][$i])));
                    $params[] = $max_min_array["GPA"][$i] = (($rawdata["GrossProfit"][$i]=='null'||$rawdata["TotalAssets"][$i]=='null'||$rawdata["TotalAssets"][$i]==0)?null:($rawdata["GrossProfit"][$i] / $rawdata["TotalAssets"][$i]));
                    $params[] = $max_min_array["BooktoMarket"][$i] = ((is_null($price)||$price==0||$rawdata["TotalStockholdersEquity"][$i]=='null'||$rawdata["TotalStockholdersEquity"][$i]==0||$rawdata["SharesOutstandingDiluted"][$i]=='null'||$rawdata["SharesOutstandingDiluted"][$i]==0)?null:(1 / ($price / ($rawdata["TotalStockholdersEquity"][$i]/(toFloat($rawdata["SharesOutstandingDiluted"][$i])*1000000)))));
                    $params[] = $max_min_array["QuickRatio"][$i] = ((($rawdata["TotalCurrentAssets"][$i]=='null'&&$rawdata["InventoriesNet"][$i]=='null')||$rawdata["TotalCurrentLiabilities"][$i]=='null'||$rawdata["TotalCurrentLiabilities"][$i]==0)?null:(($rawdata["TotalCurrentAssets"][$i] - $rawdata["InventoriesNet"][$i]) / $rawdata["TotalCurrentLiabilities"][$i]));
                    $params[] = $max_min_array["CurrentRatio"][$i] = (($rawdata["TotalCurrentAssets"][$i]=='null'||$rawdata["TotalCurrentLiabilities"][$i]=='null'||$rawdata["TotalCurrentLiabilities"][$i]==0)?null:($rawdata["TotalCurrentAssets"][$i] / $rawdata["TotalCurrentLiabilities"][$i]));
                    $params[] = $max_min_array["TotalDebt_EquityRatio"][$i] = ((($rawdata["TotalShorttermDebt"][$i]=='null'&&$rawdata["TotalLongtermDebt"][$i]=='null')||$rawdata["TotalStockholdersEquity"][$i]=='null'||$rawdata["TotalStockholdersEquity"][$i]==0)?null:(($rawdata["TotalShorttermDebt"][$i]+$rawdata["TotalLongtermDebt"][$i]) / $rawdata["TotalStockholdersEquity"][$i]));
                    $params[] = $max_min_array["LongTermDebt_EquityRatio"][$i] = ((($rawdata["TotalLongtermDebt"][$i]=='null')||$rawdata["TotalStockholdersEquity"][$i]=='null'||$rawdata["TotalStockholdersEquity"][$i]==0)?null:(($rawdata["TotalLongtermDebt"][$i]) / $rawdata["TotalStockholdersEquity"][$i]));
                    $params[] = $max_min_array["ShortTermDebt_EquityRatio"][$i] = (($rawdata["TotalShorttermDebt"][$i]=='null'||$rawdata["TotalStockholdersEquity"][$i]=='null'||$rawdata["TotalStockholdersEquity"][$i]==0)?null:($rawdata["TotalShorttermDebt"][$i] / $rawdata["TotalStockholdersEquity"][$i]));
                    $params[] = $max_min_array["AssetTurnover"][$i] = (($rawdata["TotalRevenue"][$i]=='null'||$rawdata["TotalAssets"][$i]=='null'||$rawdata["TotalAssets"][$i]==0)?null:($rawdata["TotalRevenue"][$i] / $rawdata["TotalAssets"][$i]));
                    $params[] = $max_min_array["CashPercofRevenue"][$i] = (($rawdata["CashCashEquivalentsandShorttermInvestments"][$i]=='null'||$rawdata["TotalRevenue"][$i]=='null'||$rawdata["TotalRevenue"][$i]==0)?null:($rawdata["CashCashEquivalentsandShorttermInvestments"][$i] / $rawdata["TotalRevenue"][$i]));
                    $params[] = $max_min_array["ReceivablesPercofRevenue"][$i] = (($rawdata["TotalReceivablesNet"][$i]=='null'||$rawdata["TotalRevenue"][$i]=='null'||$rawdata["TotalRevenue"][$i]==0)?null:($rawdata["TotalReceivablesNet"][$i] / $rawdata["TotalRevenue"][$i]));
                    $params[] = $max_min_array["SG_APercofRevenue"][$i] = (($rawdata["SellingGeneralAdministrativeExpenses"][$i]=='null'||$rawdata["TotalRevenue"][$i]=='null'||$rawdata["TotalRevenue"][$i]==0)?null:($rawdata["SellingGeneralAdministrativeExpenses"][$i] / $rawdata["TotalRevenue"][$i]));
                    $params[] = $max_min_array["R_DPercofRevenue"][$i] = (($rawdata["ResearchDevelopmentExpense"][$i]=='null'||$rawdata["TotalRevenue"][$i]=='null'||$rawdata["TotalRevenue"][$i]==0)?null:($rawdata["ResearchDevelopmentExpense"][$i] / $rawdata["TotalRevenue"][$i]));
                    $params[] = $max_min_array["DaysSalesOutstanding"][$i] = (($rawdata["TotalReceivablesNet"][$i]=='null'||$rawdata["TotalRevenue"][$i]=='null'||$rawdata["TotalRevenue"][$i]==0)?null:($rawdata["TotalReceivablesNet"][$i] / $rawdata["TotalRevenue"][$i] * 365));
                    $params[] = $max_min_array["DaysInventoryOutstanding"][$i] = (($rawdata["InventoriesNet"][$i]=='null'||$rawdata["CostofRevenue"][$i]=='null'||$rawdata["CostofRevenue"][$i]==0)?null:($rawdata["InventoriesNet"][$i] / $rawdata["CostofRevenue"][$i] * 365));
                    $params[] = $max_min_array["DaysPayableOutstanding"][$i] = (($rawdata["AccountsPayable"][$i]=='null'||$rawdata["CostofRevenue"][$i]=='null'||$rawdata["CostofRevenue"][$i]==0)?null:($rawdata["AccountsPayable"][$i] / $rawdata["CostofRevenue"][$i] * 365));
                    $params[] = $max_min_array["CashConversionCycle"][$i] = (($rawdata["TotalRevenue"][$i]=='null'||$rawdata["TotalRevenue"][$i]==0||$rawdata["CostofRevenue"][$i]=='null'||$rawdata["CostofRevenue"][$i]==0)?null:(($rawdata["TotalReceivablesNet"][$i] / $rawdata["TotalRevenue"][$i] * 365)+($rawdata["InventoriesNet"][$i] / $rawdata["CostofRevenue"][$i] * 365)-($rawdata["AccountsPayable"][$i] / $rawdata["CostofRevenue"][$i] * 365)));
                    if($i==1) {
                        $params[] = $max_min_array["ReceivablesTurnover"][$i] = (($rawdata["TotalRevenue"][$i]=='null'||$rawdata["TotalReceivablesNet"][$i]=='null'||$rawdata["TotalReceivablesNet"][$i]==0)?null:($rawdata["TotalRevenue"][$i] / ($rawdata["TotalReceivablesNet"][$i])));
                        $params[] = $max_min_array["InventoryTurnover"][$i] = (($rawdata["CostofRevenue"][$i]=='null'||$rawdata["InventoriesNet"][$i]=='null'||$rawdata["InventoriesNet"][$i]==0)?null:($rawdata["CostofRevenue"][$i] / ($rawdata["InventoriesNet"][$i])));
                        $params[] = $max_min_array["AverageAgeofInventory"][$i] = (($rawdata["CostofRevenue"][$i]=='null'||$rawdata["CostofRevenue"][$i]==0||$rawdata["InventoriesNet"][$i]=='null'||$rawdata["InventoriesNet"][$i]==0)?null:(365 / ($rawdata["CostofRevenue"][$i] / ($rawdata["InventoriesNet"][$i]))));
                    } else {
                        $params[] = $max_min_array["ReceivablesTurnover"][$i] = (($rawdata["TotalRevenue"][$i]=='null'||($rawdata["TotalReceivablesNet"][$i]=='null'&&is_null($arpy))||($rawdata["TotalReceivablesNet"][$i]+$arpy==0))?null:($rawdata["TotalRevenue"][$i] / (($arpy + $rawdata["TotalReceivablesNet"][$i])/2)));
                        $params[] = $max_min_array["InventoryTurnover"][$i] = (($rawdata["CostofRevenue"][$i]=='null'||($rawdata["InventoriesNet"][$i]=='null'&&is_null($inpy))||($rawdata["InventoriesNet"][$i]+$inpy==0))?null:($rawdata["CostofRevenue"][$i] / (($inpy + $rawdata["InventoriesNet"][$i])/2)));
                        $params[] = $max_min_array["AverageAgeofInventory"][$i] = (($rawdata["CostofRevenue"][$i]=='null'||($rawdata["InventoriesNet"][$i]=='null'&&is_null($inpy))||($rawdata["InventoriesNet"][$i]+$inpy==0)||$rawdata["CostofRevenue"][$i]==0)?null:(365 / ($rawdata["CostofRevenue"][$i] / (($inpy + $rawdata["InventoriesNet"][$i])/2))));
                    }
                    $params[] = $max_min_array["IntangiblesPercofBookValue"][$i] = (($rawdata["GoodwillIntangibleAssetsNet"][$i]=='null'||$rawdata["TotalStockholdersEquity"][$i]=='null'||$rawdata["TotalStockholdersEquity"][$i]==0)?null:($rawdata["GoodwillIntangibleAssetsNet"][$i] / $rawdata["TotalStockholdersEquity"][$i]));
                    $params[] = $max_min_array["InventoryPercofRevenue"][$i] = (($rawdata["InventoriesNet"][$i]=='null'||$rawdata["TotalRevenue"][$i]=='null'||$rawdata["TotalRevenue"][$i]==0)?null:($rawdata["InventoriesNet"][$i] / $rawdata["TotalRevenue"][$i]));
                    $params[] = $max_min_array["LT_DebtasPercofInvestedCapital"][$i] = ((($rawdata["TotalLongtermDebt"][$i]=='null')||($rawdata["TotalShorttermDebt"][$i]=='null'&&$rawdata["CurrentPortionofLongtermDebt"][$i]=='null'&&$rawdata["TotalStockholdersEquity"][$i]=='null'||$rawdata["TotalLongtermDebt"][$i]=='null')||($rawdata["TotalShorttermDebt"][$i]+$rawdata["CurrentPortionofLongtermDebt"][$i]+$rawdata["TotalLongtermDebt"][$i]+$rawdata["TotalStockholdersEquity"][$i]==0))?null:(($rawdata["TotalLongtermDebt"][$i]) / ($rawdata["TotalShorttermDebt"][$i]+$rawdata["CurrentPortionofLongtermDebt"][$i]+$rawdata["TotalLongtermDebt"][$i]+$rawdata["TotalStockholdersEquity"][$i])));
                    $params[] = $max_min_array["ST_DebtasPercofInvestedCapital"][$i] = (($rawdata["TotalShorttermDebt"][$i]=='null'||($rawdata["CurrentPortionofLongtermDebt"][$i]=='null'&&$rawdata["TotalLongtermDebt"][$i]=='null'&&$rawdata["TotalStockholdersEquity"][$i]=='null')||($rawdata["TotalShorttermDebt"][$i]+$rawdata["CurrentPortionofLongtermDebt"][$i]+$rawdata["TotalLongtermDebt"][$i]+$rawdata["TotalStockholdersEquity"][$i]==0))?null:($rawdata["TotalShorttermDebt"][$i] / ($rawdata["TotalShorttermDebt"][$i]+$rawdata["CurrentPortionofLongtermDebt"][$i]+$rawdata["TotalLongtermDebt"][$i]+$rawdata["TotalStockholdersEquity"][$i])));
                    $params[] = $max_min_array["LT_DebtasPercofTotalDebt"][$i] = ((($rawdata["TotalLongtermDebt"][$i]=='null')||($rawdata["TotalLongtermDebt"][$i]=='null' &&$rawdata["TotalShorttermDebt"][$i]=='null')||($rawdata["TotalShorttermDebt"][$i]+$rawdata["TotalLongtermDebt"][$i]==0))?null:(($rawdata["TotalLongtermDebt"][$i]) / ($rawdata["TotalShorttermDebt"][$i]+$rawdata["TotalLongtermDebt"][$i])));
                    $params[] = $max_min_array["ST_DebtasPercofTotalDebt"][$i] = (($rawdata["TotalShorttermDebt"][$i]=='null'||($rawdata["TotalShorttermDebt"][$i]=='null'&&$rawdata["TotalLongtermDebt"][$i]=='null')||($rawdata["TotalShorttermDebt"][$i]+$rawdata["TotalLongtermDebt"][$i]==0))?null:($rawdata["TotalShorttermDebt"][$i] / ($rawdata["TotalShorttermDebt"][$i]+$rawdata["TotalLongtermDebt"][$i])));
                    $params[] = $max_min_array["TotalDebtPercofTotalAssets"][$i] = ((($rawdata["TotalShorttermDebt"][$i]=='null'&&$rawdata["TotalLongtermDebt"][$i]=='null')||$rawdata["TotalAssets"][$i]=='null'||$rawdata["TotalAssets"][$i]==0)?null:(($rawdata["TotalShorttermDebt"][$i]+$rawdata["TotalLongtermDebt"][$i]) / $rawdata["TotalAssets"][$i]));
                    $params[] = $max_min_array["WorkingCapitalPercofPrice"][$i] = (($rawdata["TotalCurrentAssets"][$i]=='null'&&$rawdata["TotalCurrentLiabilities"][$i]=='null')||$rawdata["SharesOutstandingDiluted"][$i]=='null'||$rawdata["SharesOutstandingDiluted"][$i]==0||is_null($price)||$price==0)?null:((($rawdata["TotalCurrentAssets"][$i] - $rawdata["TotalCurrentLiabilities"][$i]) / (toFloat($rawdata["SharesOutstandingDiluted"][$i])*1000000))/$price); 
                    try {
                        $res = $db->prepare($query);
                        $res->execute($params);
                    } catch(PDOException $ex) {

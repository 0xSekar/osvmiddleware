		...
		if (mysql_affected_rows()>0) {
			...
			if($i < 11) {
				...
				$query .= "'".$report_id."',";
		                ...
		                $query .= (($rawdata["CashCashEquivalentsandShorttermInvestments"][$i]=='null' ||($rawdata["CashCashEquivalentsandShorttermInvestments"][$i]=='null'&&$rawdata["TotalCurrentLiabilities"][$i]=='null'&&$rawdata["TotalCurrentAssets"][$i]=='null'&&$rawdata["CashCashEquivalentsandShorttermInvestments"][$i]=='null'))?'null':(($rawdata["CashCashEquivalentsandShorttermInvestments"][$i] - $rawdata["ShorttermInvestments"][$i]) - max(0, ($rawdata["TotalCurrentLiabilities"][$i]-$rawdata["TotalCurrentAssets"][$i]+$rawdata["CashCashEquivalentsandShorttermInvestments"][$i]-$rawdata["ShorttermInvestments"][$i])))).",";

		...
		//if (mysql_affected_rows()>0) {
			...
			//$query = "INSERT INTO `reports_gf_data` (`report_id`, `fiscalPeriod_eol`, `fiscalPeriod_gf`, `InterestIncome`, `InterestExpense`, `EPSBasic`, `EPSDiluted`, `SharesOutstandingDiluted`, `InventoriesRawMaterialsComponents`, `InventoriesWorkInProcess`, `InventoriesInventoriesAdjustments`, `InventoriesFinishedGoods`, `InventoriesOther`, `TotalInventories`, `LandAndImprovements`, `BuildingsAndImprovements`, `MachineryFurnitureEquipment`, `ConstructionInProgress`, `GrossPropertyPlantandEquipment`, `SharesOutstandingBasic`) VALUES (";
        		...
        		$query .= ")";*/
                        ...
                        $params[] = ($rawdata["EPSBasic"][$i] =='null' ? null:toFloat($rawdata["EPSBasic"][$i]));
                        $params[] = ($rawdata["EPSDiluted"][$i] =='null' ? null:toFloat($rawdata["EPSDiluted"][$i]));
                        $params[] = ($rawdata["SharesOutstandingDiluted"][$i] =='null' ? null:toFloat($rawdata["SharesOutstandingDiluted"][$i]));
                        $params[] = ($rawdata["InventoriesRawMaterialsComponents"][$i] =='null' ? null:toFloat($rawdata["InventoriesRawMaterialsComponents"][$i]));
                        $params[] = ($rawdata["InventoriesWorkInProcess"][$i] =='null' ? null:toFloat($rawdata["InventoriesWorkInProcess"][$i]));
                        $params[] = ($rawdata["InventoriesInventoriesAdjustments"][$i] =='null' ? null:toFloat($rawdata["InventoriesInventoriesAdjustments"][$i]));
                        $params[] = ($rawdata["InventoriesFinishedGoods"][$i] =='null' ? null:toFloat($rawdata["InventoriesFinishedGoods"][$i]));
                        $params[] = ($rawdata["InventoriesOther"][$i] =='null' ? null:toFloat($rawdata["InventoriesOther"][$i]));
                        $params[] = ($rawdata["TotalInventories"][$i] =='null' ? null:toFloat($rawdata["TotalInventories"][$i]));
                        $params[] = ($rawdata["LandAndImprovements"][$i] =='null' ? null:toFloat($rawdata["LandAndImprovements"][$i]));
                        $params[] = ($rawdata["BuildingsAndImprovements"][$i] =='null' ? null:toFloat($rawdata["BuildingsAndImprovements"][$i]));
                        $params[] = ($rawdata["MachineryFurnitureEquipment"][$i] =='null' ? null:toFloat($rawdata["MachineryFurnitureEquipment"][$i]));
                        $params[] = ($rawdata["ConstructionInProgress"][$i] =='null' ? null:toFloat($rawdata["ConstructionInProgress"][$i]));
                        $params[] = ($rawdata["GrossPropertyPlantandEquipment"][$i] =='null' ? null:toFloat($rawdata["GrossPropertyPlantandEquipment"][$i]));
                        $params[] = ($rawdata["SharesOutstandingBasic"][$i] =='null' ? null:toFloat($rawdata["SharesOutstandingBasic"][$i]));
	        	//mysql_query($query) or die ($query."\n".mysql_error());
                        try {
                                $res = $db->prepare($query);
                                $res->execute($params);

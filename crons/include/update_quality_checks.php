...
function update_pio_checks($ti = null) {
	...
	$first = true;
        ...
        $query2 = $params[1].",".$params[2].",".$params[3].",".$params[4].",".$params[5].",".$params[6].",".$params[7].",".$params[8].",".$params[9].",".$params[10].")"; 
        //echo "\n------ QUERY 2 : ".$query2."\n";
        try {
...
function pioTTM($ppid,$prawdata,$querypre,$pprawdata) {
        ...
        if ($rowqtr["fiscal_year"] == $prawdata["fiscal_year"] && $rowqtr["fiscal_quarter"] == $prawdata["fiscal_quarter"]) {
                ...
                $query = $params[1].",".$params[2].",".$params[3].",".$params[4].",".$params[5].",".$params[6].",".$params[7].",".$params[8].",".$params[9].",".$params[10].")";
                try {
                        $res1 = $db->prepare($query1);
                        $res1->execute($params);
                } catch(PDOException $ex) {
...
function beneishTTM($ppid,$prawdata,$querypre) {
        ...
        if ($rowqtr["fiscal_year"] == $prawdata["fiscal_year"] && $rowqtr["fiscal_quarter"] == $prawdata["fiscal_quarter"]) {
                ...
                $query1 = "INSERT INTO `ttm_beneish_checks` (`ticker_id`, `DSRI`, `GMI`, `AQI`, `SGI`, `DEPI`, `SGAI`, `TATA`, `LVGI`, `BM5`, `BM8`) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";//.$querypre;
                //$query1 .= "'".$ppid."',";
                //$params = array();
                $params = $querypre;
                ...
                //mysql_query($query1.$querypre) or die (mysql_error());
echo "\nQuery1: ".$query1."\n";
echo "\nID + Querypre: ".$ppid.", ".var_dump($querypre)."\n";
echo "\nParams: ".$params[0]." , ".$params[1]." , ".$params[2]." , ".$params[3]." , ".$params[4]." , ".$params[5]." , ".$params[6]." , ".$params[7]." , ".$params[8]." , ".$params[9]." , ".$params[10]."\n";
                try {
                        $res1 = $db->prepare($query1);
                        $res1->execute($params);
                } catch(PDOException $ex) {

...
ALTER TABLE  `screener_filter_fields` ADD  `metadata_id` INT NOT NULL AFTER  `field_id` ,
ADD INDEX (  `metadata_id` ) ;

ALTER TABLE  `screener_filter_fields2` ADD  `metadata_id` INT NOT NULL AFTER  `field_id` ,
ADD INDEX (  `metadata_id` ) ;

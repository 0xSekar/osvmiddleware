...
$max_min_tables = array("5yr_max_accrual_checks", "5yr_max_alt_checks", "5yr_max_beneish_checks", "5yr_max_key_ratios", "5yr_max_pio_checks", "5yr_median_accrual_checks", "5yr_median_alt_checks", "5yr_median_beneish_checks", "5yr_median_key_ratios", "5yr_median_pio_checks", "5yr_min_accrual_checks", "5yr_min_alt_checks", "5yr_min_beneish_checks", "5yr_min_key_ratios", "5yr_min_pio_checks");
$ttm_tables = array("ttm_balanceconsolidated","ttm_balancefull","ttm_cashflowconsolidated","ttm_cashflowfull","ttm_incomeconsolidated","ttm_incomefull","ttm_financialscustom", "ttm_gf_data","ttm_alt_checks","ttm_beneish_checks","ttm_key_ratios","ttm_pio_checks","ttm_ratings","ttm_ratings_history","mrq_alt_checks","ttm_dupont_checks","ttm_accrual_checks");
...
foreach($max_min_tables as $table) {
    $query = "DELETE FROM $table WHERE ticker_id = ".$ticker_id;
    try {
        $db->exec($query);
    } catch(PDOException $ex) {

...
set_time_limit(0);                   // ignore php timeout
	...
	while ($rawdata = mysql_fetch_assoc($res)) {
		...
		$query .= ((is_null($rawdata["CashCashEquivalentsandShorttermInvestments"]) || (is_null($rawdata["CashCashEquivalentsandShorttermInvestments"])&&is_null($rawdata["TotalCurrentLiabilities"])&&is_null($rawdata["TotalCurrentAssets"])&&is_null($rawdata["CashCashEquivalentsandShorttermInvestments"])))?'null':(($rawdata["CashCashEquivalentsandShorttermInvestments"] - $rawdata["ShorttermInvestments"]) - max(0, ($rawdata["TotalCurrentLiabilities"]-$rawdata["TotalCurrentAssets"]+$rawdata["CashCashEquivalentsandShorttermInvestments"] - $rawdata["ShorttermInvestments"])))).",";
